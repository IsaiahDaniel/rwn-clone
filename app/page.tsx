			...
			<main>
						...
						<div className="w-[70%] flex flex-col items-center justify-center text-center">
							<div>
								<h1 className="md:text-[62px] font-extrabold flex items-center text-center">
									...
									<Image src={TechnologyImage} width={300} height={100} alt="" />
							...
							<p className="mt-10">
								We build and maintain Software products across Fintech, Data Analytics, AI, <br /> E-commerce while offering top-notch IT Support
								Service
							</p>
							<Button text="Hire Us" to="/hire-us" classNames="mt-10" />
						</div>
					...
					<section className="mt-[900px] grid grid-cols-1 gap-5 md:grid-cols-2 items-center px-4 md:px-0">
						<div>
							<div>
								...
								<h1 className="text-4xl mt-4 text-purpleLight">We Specialise in Providing Cost-effective Digital Solution</h1>
								<p className="text-purpleLight mt-4">
									RemotewebNET Dynamics Ltd. is a leading IT company that specialises in providing innovative and cost-effective digital solutions to
									clients worldwide. Since its inception in 2012, the company has been at the forefront of the technology landscape, delivering
									high-quality services in web development, mobile App development, software solutions, Support, digital marketing amongst others.
								</p>
							</div>
						</div>
					...
					<div className="flex flex-col items-center justify-center text-center h-full text-white mt-36">
						<div className="w-[70%] flex flex-col items-center justify-center text-center">
							<h1 className="text-xl md:text-[52px] font-extrabold flex items-center justify-center leading-10 mt-7 text-center">
								We deliver exceptionally efficient and secure software applications with seamless user experience
							</h1>
							...
							<div className="grid grid-cols-1 md:grid-cols-4 mt-10 gap-20 z-30">
								{SERVICES_CARD.map((card) => (
									<Card classNames="w-[300px] h-auto px-3 py-5">
										...
										<div>
											<h1 className="text-purpleLight text-left text-xl mb-5">{card.title}</h1>
											<p className="text-purpleLight text-left text-sm">{card.subText}</p>
										</div>
									</Card>
								))}
							</div>
				...
				<section className="bg-[#F4F6FF] px-10 py-48">
					<div className="w-[80%] mx-auto">
						...
						<div>
							<h2 className="md:text-3xl">we bring cutting-edge technological solutions to the table to enhancing efficiency and productivity.</h2>
						</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-3 mt-10 gap-5 z-30">
								{SERVICES.map((card, index) => (
									<Card classNames="" key={card.id}>
										...
										<div className="p-5">
											<h1 className="text-purpleLight text-left text-xl mb-5">{card.text}</h1>
											<p className="text-purpleLight text-left text-sm">{truncatedText[index] ? truncate(card.subText, 200) : card.subText}</p>
											<p className="text-right" onClick={() => toggleTruncation(index)}>
						...
						<main>
							...
							<div className="md:flex">
								<div>
									...
									<p className="w-[80%] mb-4">
										Kobokolet is a tool to register small holder farmers and their farms in the KoboWeb ecosystem, enabling them to access 0% input
										loans, improve market connections, and achieve financial inclusion.
									</p>
								</div>
							...
							<div>
								<div
									...
									<div className={"hover:bg-[rgba(0,0,0,0.3)] h-full w-full bg-white/2 z-0 absolute top-0 left-0 right-0 bottom-0"} />
									<div className="flex flex-col items-center justify-center h-full">
					...
					<section className="relative top-0 right-0 left-0 bg-[#090E2F] h-full md:h-[800px]">
						...
						<div className="container mx-auto flex flex-col justify-center h-full">
							<div className="md:flex justify-between px-10 md:px-20 text-white">
								...
								<div>
									<textarea className="bg-[#0D154B] rounded-md border border-[#4E589C] px-2 w-full py-2 h-[100px]" placeholder="message"></textarea>
									<input type="text" placeholder="Name" className="bg-[#0D154B] rounded-md w-full border border-[#4E589C] py-5 px-2" />
									<br />
									<input type="text" placeholder="Email Address" className="bg-[#0D154B] rounded-md w-full border border-[#4E589C] py-5 px-2 mt-5" />
									<br />
							...
							<div className="mx-auto mt-10">
								<div className="w-[90vw]">
									<Card classNames="grid grid-cols-2 md:grid-cols-4 py-10 px-5 glass-bg-card w-full text-white">
										<div>
											<Image src={ClockIcon} width={50} height={50} alt="" className="mb-5" />
											<h2>Working Hours</h2>
											<div>
										...
										<div>
											<Image src={PhoneIcon} width={50} height={50} alt="" className="mb-5" />
											<h2>Call Us</h2>
											<div>
												<p>Monday to Friday</p>
												<p>8:00 - 5:00pm</p>
										...
										<div>
											<Image src={MailIcon} width={50} height={50} alt="" className="mb-5" />
											<h2>Working Hours</h2>
											<div>
												<p>Monday to Friday</p>
												<p>8:00 - 5:00pm</p>
